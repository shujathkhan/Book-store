...
export class ProductsService {
  ...
  private search = '';
  private layoutMode = window.localStorage.getItem('bookStoreLayout') === 'list' ? false : true;
  ...
  cartProductManipulate(product: Product) {
  ...
  removeCartSingleItem(itemIndex: number) {
    ...
    const removedProductName = this.cartAddedProducts[itemIndex].title;
  ...
  setLayout(layoutValue: boolean) {
    window.localStorage.setItem('bookStoreLayout', layoutValue ? 'grid' : 'list');
